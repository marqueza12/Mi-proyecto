$(document).ready(function() {
    ...
    // Slider
    //aqui con el script ya cargado (paso c) configuramos las caracteristicas del slider
    if (window.location.href.indexOf('index') > -1) {

        //aqui esditas el Slider cargado
        $('.galeria').bxSlider({
            mode: 'fade',
            captions: false,
            slideWidth: 1500,
    ...
    //boton para subir al pixcel 0(principio de la pagina)
    $('.subir').click(function(e) {
        e.preventDefault(); //esto es para que la pagina no se redirija a otro sitio
    ...
    if (form_name != null && form_name != "undefined") {
        ...
        $("#logout").click(function() {
            localStorage.clear();
            location.reload(); //para recargar la pagina al darle click
        });
